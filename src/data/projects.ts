...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'A Brthrs client, a Dutch investigation firm, needed to analyse thousands of court cases nationwide and surface geographic patterns in case law. As lead product builder I owned the build end to end: an API scraper and AI analysis engine that processes case law across the Netherlands, powering a map-based frontend for exploring legal insights geographically and surfacing patterns humans would never spot manually.',
    tags: ['Brthrs client', 'Lead product builder', 'AI Analysis', 'Web Scraping'],
